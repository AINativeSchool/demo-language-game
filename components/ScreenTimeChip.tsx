...
export default function ScreenTimeChip() {
  ...
  return (
    <Link
      href="/shop"
      title="Screen-Time Shop"
      className="inline-flex shrink-0 items-center gap-1 rounded-full bg-accent-100 px-2.5 py-1 text-xs font-extrabold text-accent-800 shadow-[0_2px_0_0_var(--color-accent-200)] transition hover:bg-accent-200"
    >
