...
2. Configure the LLM. Copy the example env file and add your key:
...
- `lib/` - resilient LLM client, localStorage store, scenarios, types, constants

## Out of scope (v1)
Accounts, teacher dashboards, multiplayer, voice, native mobile, and real (enforced) screen-time control.
